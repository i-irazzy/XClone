...
Q_CONSTINIT static const qt_meta_stringdata_AuthRegForm_t qt_meta_stringdata_AuthRegForm = {
    {
        ...
        QT_MOC_LITERAL(12, 7),  // "auth_ok"
        QT_MOC_LITERAL(20, 0),  // ""
        QT_MOC_LITERAL(21, 8),  // "username"
        QT_MOC_LITERAL(30, 26),  // "on_pushButtonToReg_clicked"
        QT_MOC_LITERAL(57, 26),  // "on_pushButtonLogIn_clicked"
        QT_MOC_LITERAL(84, 27)   // "on_pushButtonSignUp_clicked"
    },
    "AuthRegForm",
    "auth_ok",
    "",
    "username",
    "on_pushButtonToReg_clicked",
...
Q_CONSTINIT const QMetaObject AuthRegForm::staticMetaObject = { {
    ...
    qt_incomplete_metaTypeArray<qt_meta_stringdata_AuthRegForm_t,
        ...
        // method 'on_pushButtonToReg_clicked'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
...
void AuthRegForm::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->on_pushButtonToReg_clicked(); break;
        case 2: _t->on_pushButtonLogIn_clicked(); break;
        case 3: _t->on_pushButtonSignUp_clicked(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &AuthRegForm::auth_ok; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
